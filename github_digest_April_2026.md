...
**PRs merged & closed:**
- [#630 - fix: [LOB-2078] Dual status fisplay for reconciled transactions.](https://github.com/cardano-foundation/cf-reeve-platform/pull/630)
- [#629 - Revert "[LOB-2080]  Implement Manual Transaction Exclusion for Reporting and Reconciliation"](https://github.com/cardano-foundation/cf-reeve-platform/pull/629)
- [#628 - fix: [LOB-2078] Dual status fisplay for reconciled transactions.](https://github.com/cardano-foundation/cf-reeve-platform/pull/628)
- [#627 - Fix/lob 1976 be optimize batch statistics calculation job](https://github.com/cardano-foundation/cf-reeve-platform/pull/627)
- [#626 - feat: [LOB-2060] Report template search and filter](https://github.com/cardano-foundation/cf-reeve-platform/pull/626)
- [#625 - [LOB-2080]  Implement Manual Transaction Exclusion for Reporting and Reconciliation](https://github.com/cardano-foundation/cf-reeve-platform/pull/625)
- [#624 - chore: bumping platform version to 1.6](https://github.com/cardano-foundation/cf-reeve-platform/pull/624)
- [#623 - chore: [LOB-2039]  report templates table update](https://github.com/cardano-foundation/cf-reeve-platform/pull/623)
- [#622 - fix: fixing version increase](https://github.com/cardano-foundation/cf-reeve-platform/pull/622)
- [#621 - upgrade release 1.6.0](https://github.com/cardano-foundation/cf-reeve-platform/pull/621)
- [#617 - chore(gradle): upgrade to 8.14](https://github.com/cardano-foundation/cf-reeve-platform/pull/617)
- [#608 - fix: [LOB-1598] unify 409 error message returned from BE for setup tables](https://github.com/cardano-foundation/cf-reeve-platform/pull/608)
- [#588 - Release/1.5.0](https://github.com/cardano-foundation/cf-reeve-platform/pull/588)
...
**PRs merged & closed:**
- [#50 - chore: added publish handler to allow registration with conway cert](https://github.com/cardano-foundation/cip113-programmable-tokens/pull/50)
- [#49 - Feat/split onchain and offchain](https://github.com/cardano-foundation/cip113-programmable-tokens/pull/49)
- [#48 - Feat/adding cip113 sdk](https://github.com/cardano-foundation/cip113-programmable-tokens/pull/48)
- [#46 - Minor cleanups](https://github.com/cardano-foundation/cip113-programmable-tokens/pull/46)
- [#45 - Fix/minting proof and composability 2](https://github.com/cardano-foundation/cip113-programmable-tokens/pull/45)
