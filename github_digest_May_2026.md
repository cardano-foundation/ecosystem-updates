...
**PRs merged & closed:**
- [#636 - chore(scope): ensure that transaction id is always part of sorting keys](https://github.com/cardano-foundation/cf-reeve-platform/pull/636)
- [#634 - fix: enabling follower to parse ipfs](https://github.com/cardano-foundation/cf-reeve-platform/pull/634)
- [#633 - Feat/saver report template order from UI test](https://github.com/cardano-foundation/cf-reeve-platform/pull/633)
- [#632 - feat: save report template order from UI request](https://github.com/cardano-foundation/cf-reeve-platform/pull/632)
- [#631 - feat: order field in reports](https://github.com/cardano-foundation/cf-reeve-platform/pull/631)
...
- [#65 - Reference Script Preservation in `ThirdPartyAct` Path](https://github.com/cardano-foundation/cip113-programmable-tokens/issues/65)
...
- [#62 - Redundant Single Mint Redeemer Check in `issuance_mint` Validator](https://github.com/cardano-foundation/cip113-programmable-tokens/issues/62)
...
- [#59 - Separation of Concerns](https://github.com/cardano-foundation/cip113-programmable-tokens/issues/59)
...
**PRs merged & closed:**
- [#70 - refactor(registry): Drop Redundant Length and Ordering Checks in RegistryInsert (Finding 19)](https://github.com/cardano-foundation/cip113-programmable-tokens/pull/70)
- [#69 -   fix(programmable-logic): Reference Script Preservation in ThirdPartyAct (Finding 13)](https://github.com/cardano-foundation/cip113-programmable-tokens/pull/69)
- [#68 - refactor(issuance): Remove Redundant Single-Mint Check and Flatten Redeemer to MintingRegistryProof](https://github.com/cardano-foundation/cip113-programmable-tokens/pull/68)
- [#52 - feat(registry): Separation of Concerns - Allow both Registration and Registration and First Mint of a Programmable Token](https://github.com/cardano-foundation/cip113-programmable-tokens/pull/52)
- [#51 - Fix audit findings 3, 8 and 9](https://github.com/cardano-foundation/cip113-programmable-tokens/pull/51)
...
- [#16 - Single wallet  can register multiple tokens](https://github.com/cardano-foundation/cip113-programmable-tokens/issues/16)
- [#10 - Creating docs to write step  while registering the token for both bafin and Dummy.](https://github.com/cardano-foundation/cip113-programmable-tokens/issues/10)
